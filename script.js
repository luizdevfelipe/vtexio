try{var waitUntilExists=function(t,n){var a=setInterval(function(){var e=$(t);e.length&&(clearInterval(a),n(e))},300)};function updateSteps(){let a=["cart","email","profile","shipping","payment"],i=window?.location?.hash.split("/");waitUntilExists(".cart-container",e=>{var t=i.includes(a[0]),n=0<a.indexOf(i[1]);vendorCoupon(),e.toggleClass("cart-container--active",t),e.toggleClass("cart-container--success",n)}),waitUntilExists(".profile-container",e=>{var t=i.includes(a[1])||i.includes(a[2]),n=2<a.indexOf(i[1]);e.toggleClass("profile-container--active",t),e.toggleClass("profile-container--success",n)}),waitUntilExists(".shipping-container",e=>{var t=i.includes(a[3]),n=3<a.indexOf(i[1]);e.toggleClass("shipping-container--active",t),e.toggleClass("shipping-container--success",n)}),waitUntilExists(".payment-container",e=>{var t=i.includes(a[4]),n=4<a.indexOf(i[1]);e.toggleClass("payment-container--active",t),e.toggleClass("payment-container--success",n)}),waitUntilExists(".payment-data",e=>{var t=i.includes(a[3]);e.toggleClass("shipping--active",t)}),waitUntilExists("#shipping-data",e=>{var t=i.includes(a[4]);e.toggleClass("payment--active",t)})}$(window).on("hashchange",()=>{updateSteps()}),$(document).ready(function(){updateSteps()})}catch(e){console.log(e)}var intervalo1=setInterval(()=>{0<$(".btn-place-order-wrapper").length&&0<$(".free-shipping").length&&($(".btn-place-order-wrapper").insertAfter(".free-shipping"),clearInterval(intervalo1))},100),intervalo2=setInterval(()=>{0<$(".link-choose-more-products-wrapper").length&&0<$(".free-shipping").length&&($(".link-choose-more-products-wrapper").insertBefore(".free-shipping"),clearInterval(intervalo2))},100);function tamanhoImg(){var e=setInterval(()=>{0<$(".product-item .product-image img").length&&($(".product-item .product-image img").each(function(e,t){var n=$(t).attr("src").replace("55-55","100-100");$(t).attr("src",n)}),clearInterval(e))},500)}function findPackaging(a){let e=setInterval(()=>{0<$(".product-item").length&&(clearInterval(e),$(".product-item").each(function(e,t){let n=$(t).attr("data-sku");a.items.map(e=>{e.id===n&&(0<e.attachmentOfferings.length&&e.attachmentOfferings.map(e=>{"vtex.subscription.assinatura"===e.name&&$(t).addClass("haveRecorrence")}),0<e.attachments.length)&&e.attachments.map(e=>{"vtex.subscription.assinatura"===e.name&&$(t).addClass("haveRecorrenceAdd")})})}))},200)}$(window).on("orderFormUpdated.vtex",function(e,t){tamanhoImg(),findPackaging(t)}),$(document).ready(function(){tamanhoImg();var e=setInterval(()=>{0<$(".srp-data #shipping-calculate-link").length&&($(".srp-data #shipping-calculate-link").click(),clearInterval(e))},100)});let verifyCode=async t=>{if(!t)return{isValid:!1,sellerName:""};try{var e=(await(await fetch("/api/dataentities/SS/search?_fields=Name,RCA",{headers:{"REST-Range":"resources=0-2000"}})).json()).find(e=>e.RCA===t);return{isValid:!!e,sellerName:e?e.name:""}}catch(e){return console.error("Error verifying seller code:",e),{isValid:!1,sellerName:""}}},vendorCoupon=()=>{vtexjs.checkout.getOrderForm().then(function(n){var e=n.marketingData&&n.marketingData.utmiCampaign;let t;t=e?`
...
`,openDeleteAllModal=e=>{var t=$("#"+deleteAllModalIds.container),n=$("#"+deleteAllModalIds.button.confirm);t.removeClass(deleteAllModalVisibilityClasses.hidden).addClass(deleteAllModalVisibilityClasses.visible).attr("aria-hidden","false"),n.focus()},closeDeleteAllModal=e=>{$("#"+deleteAllModalIds.container).addClass(deleteAllModalVisibilityClasses.hidden).removeClass(deleteAllModalVisibilityClasses.visible).attr("aria-hidden","true")},deleteAllHandler=e=>{let t=$("#"+deleteAllModalIds.button.confirm);t.html(deleteAllModalSpinner),window.scroll({top:0,behavior:"instant"}),vtexjs.checkout.removeAllItems().done(function(){setTimeout(()=>{t.html(deleteAllModalTexts.button.confirm),closeDeleteAllModal(e)},500)})};try{$(document).ready(function(){let a=$(`
        <button
      ...
      `);$(document.body).append(e),waitUntilExists(titlevitrineSelector,e=>{a.insertAfter(e)}),$(window).on("orderFormUpdated.vtex",function(e,t){var t=t.items.length<=0,n=$("#"+deleteAllButtonId);t?n.remove():1<=n.length||waitUntilExists(titlevitrineSelector,e=>{a.insertAfter(e)})})})}catch(e){console.error("delete-all err",e)}async function insertModal(){await new Promise(e=>{document.body.insertAdjacentHTML("beforeend",`
           ...
           `),e(!0)})}async function insertShareCart(a){return vtexjs.checkout.getOrderForm().then(e=>{if(0<document.querySelectorAll(".orderform-template .custom-div").length)return!1;var t=document.querySelector(".custom-div"),n=document.querySelector(a);n&&!t&&n.insertAdjacentHTML("beforebegin",`
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M9.69694 2.99971C9.69694 1.34371 11.1087 1.09319e-05 12.848 1.09319e-05C13.261 -0.00105405 13.6701 0.0757039 14.0521 0.225899C14.434 0.376093 14.7812 0.596781 15.074 0.875353C15.3667 1.15392 15.5991 1.48492 15.758 1.84942C15.9169 2.21393 15.9991 2.6048 16 2.99971C16 4.65661 14.5882 6.0003 12.848 6.0003C12.4307 6.0006 12.0175 5.92167 11.6323 5.76811C11.2472 5.61454 10.8977 5.38939 10.6042 5.10571L6.24188 7.9461C6.36315 8.52481 6.30357 9.12485 6.07059 9.6714L10.8536 12.6774C11.4172 12.2383 12.122 11.9989 12.8489 11.9997C13.2619 11.9988 13.671 12.0756 14.0529 12.2259C14.4348 12.3762 14.782 12.597 15.0746 12.8757C15.3673 13.1543 15.5996 13.4854 15.7584 13.8499C15.9172 14.2145 15.9993 14.6054 16 15.0003C16 16.6563 14.5882 18 12.848 18C12.4351 18.0009 12.0261 17.9241 11.6442 17.7738C11.2624 17.6236 10.9153 17.4029 10.6226 17.1243C10.33 16.8458 10.0977 16.5148 9.93884 16.1504C9.78 15.7859 9.69781 15.3951 9.69694 15.0003C9.69621 14.5797 9.78892 14.1637 9.96894 13.7799L5.22353 10.8C4.64868 11.2775 3.91253 11.54 3.15106 11.5389C2.73809 11.5398 2.32897 11.463 1.94707 11.3127C1.56518 11.1624 1.218 10.9416 0.925376 10.6629C0.632748 10.3843 0.400406 10.0532 0.241626 9.68865C0.0828465 9.3241 0.000740683 8.93321 0 8.5383C0.000864162 8.14347 0.0830612 7.75267 0.241896 7.38823C0.400731 7.02378 0.633092 6.69282 0.925708 6.41427C1.21832 6.13571 1.56546 5.915 1.94729 5.76475C2.32912 5.6145 2.73817 5.53766 3.15106 5.53861C4.15247 5.53861 5.04282 5.9823 5.61976 6.6735L9.84847 3.92041C9.7476 3.62305 9.69646 3.31232 9.69694 2.99971Z" fill="black"/>
      ...
      `)})}function getBrasiliaDateInfo(){var e=new Intl.DateTimeFormat("en-US",{timeZone:"America/Sao_Paulo",hour:"numeric",hour12:!1,weekday:"short"}).formatToParts(new Date);let t=Number(e.find(e=>"hour"===e.type).value);24===t&&(t=0);e=e.find(e=>"weekday"===e.type).value;return{hour:t,day:{Sun:0,Mon:1,Tue:2,Wed:3,Thu:4,Fri:5,Sat:6}[e]}}function isExpressShipping(e){return!!e&&("expresso"===(e=String(e).trim().toLowerCase())||"expressa"===e)}function getExpressDeliveryMessage(e){var{hour:t,day:n}=getBrasiliaDateInfo();return 0===n||6===n&&18<=t?"Em até 60 minutos a partir de segunda-feira às 11h00":t<11?"Em até 60 minutos a partir das 11h00":18<=t?"Em até 60 minutos a partir de amanhã às 11h00":e||"Em até 60 minutos"}$(window).on("load",async function(){await insertModal();var e=document.querySelector(".custom-div");e&&e.remove(),"#/cart"===location.hash?await insertShareCart("body.body-cart .cart-more-options",!0):await insertShareCart("body.body-cart .orderform-template",!1);let t=document.querySelector(".bf-shared-cart__modal"),n=document.querySelector(".bf-shared-cart__modal a"),a=document.querySelector(".bf-shared-cart__overlay");var e=document.querySelector("#bf-shared-cart"),i=document.getElementById("bf-shared-cart__copy"),o=document.getElementById("bf-shared-modal__close-button");e&&e.addEventListener("click",async function(e){e.preventDefault(),e.stopPropagation();e=vtexjs.checkout.orderForm.orderFormId;n.innerHTML=`https://www.pensefarma.com.br/checkout/?orderFormId=${e}#/cart`,a.classList.remove("hidden"),t.classList.remove("hidden")}),a.addEventListener("click",function(e){e.stopPropagation(),e.target.classList.contains("bf-shared-cart__overlay")&&(a.classList.add("hidden"),t.classList.add("hidden"))}),i.addEventListener("click",function(e){var t=document.createRange();t.selectNode(n),window.getSelection().addRange(t),document.execCommand("copy"),window.getSelection().removeAllRanges(),$(".bf-shared-cart__info-text").fadeIn(),setTimeout(()=>$(".bf-shared-cart__info-text").fadeOut(),2500)}),o.addEventListener("click",function(){a.classList.add("hidden"),t.classList.add("hidden")})}),$(window).on("hashchange",()=>{updateSteps(),"#/cart"===location.hash?insertShareCart("body.body-cart .cart-more-options",!0):insertShareCart("body.body-cart .orderform-template",!1)});var shippingOptionsSyncInterval=null;function clearCustomShippingOptions(){$("#r").remove()}function shouldClearCustomShippingOptions(){return 0<$(".shp-alert-shipping-unavailable").length||0<$(".srp-postal-code").length||!$(".srp-delivery-select").length||!$(".srp-delivery-select option").length}function scheduleShippingOptionsSync(){shippingOptionsSyncInterval&&clearInterval(shippingOptionsSyncInterval);var e=0;shippingOptionsSyncInterval=setInterval(function(){e++,0<$(".shp-alert-shipping-unavailable").length||0<$(".srp-postal-code").length?(clearCustomShippingOptions(),clearInterval(shippingOptionsSyncInterval),shippingOptionsSyncInterval=null):$(".srp-delivery-select").length?(checkShippingOptions(),clearInterval(shippingOptionsSyncInterval),shippingOptionsSyncInterval=null):30<=e&&(clearCustomShippingOptions(),clearInterval(shippingOptionsSyncInterval),shippingOptionsSyncInterval=null)},100)}function checkShippingOptions(){if(clearCustomShippingOptions(),!shouldClearCustomShippingOptions()){$(".srp-delivery-select-container").css("display","none");let s=$('<div id="r"></div>').insertAfter(".srp-result");$(".srp-delivery-select option").each(function(e,t){var n=$(this).parent().attr("label")||$(this).val();let a=$.trim(this.textContent.split("-")[0]||"");(isExpressShipping(n)||isExpressShipping($(this).val()))&&(a=getExpressDeliveryMessage(a));var n=$("<div class='shipping-option-info'><div class='shipping-option-info-container'><label><b>"+$(this).parent().attr("label")+"</b><span class='shipping-option-text'>"+a+"</span></label><span class='shipping-option-price'>"+this.textContent.split("-")[1]+"</span></div></div>"),i=$("<div class='shipping-option-info-input'><div></div></div>").attr("value",$(this).val()),o=$("<input type='radio' name='r' />").attr("value",$(this).val()).attr("checked",!!$(this).is(":selected")).click(function(){$(".srp-delivery-select").val($(this).val());var e=$(this).closest(".shipping-option-info").find("span.shipping-option-text").text();e?$("span.shipping-estimate-date:not(.shipping-estimate-detail)").text(e):$("span.shipping-estimate-date:not(.shipping-estimate-detail)").text(this.textContent.split("-")[0])});i.prepend(o),n.prepend(i),s.append(n),$(this).is(":selected")&&$("span.shipping-estimate-date:not(.shipping-estimate-detail)").text(a)})}}function renderModal(){var e=document.createElement("div");return e.className="modal-signature",e.innerHTML=`
...
<path d="M9.66667 15.9H7.44444V18.1H9.66667V15.9ZM14.1111 15.9H11.8889V18.1H14.1111V15.9ZM18.5556 15.9H16.3333V18.1H18.5556V15.9ZM20.7778 8.2H19.6667V6H17.4444V8.2H8.55556V6H6.33333V8.2H5.22222C3.98889 8.2 3 9.19 3 10.4V25.8C3 26.3834 3.23412 26.943 3.65088 27.3556C4.06762 27.7682 4.63286 28 5.22222 28H20.7778C21.3671 28 21.9323 27.7682 22.3491 27.3556C22.7659 26.943 23 26.3834 23 25.8V10.4C23 9.81653 22.7659 9.25695 22.3491 8.84437C21.9323 8.43178 21.3671 8.2 20.7778 8.2ZM20.7778 25.8H5.22222V13.7H20.7778V25.8Z" fill="#211E1E"/>
  ...
  `,document.body.appendChild(e),$(document).on("click",".openModal",function(){$(".modal-overlay").css({display:"flex"}),$(".modal-overlay").fadeIn()}),$(document).on("click",".close-btn",function(){$(".modal-overlay").fadeOut()}),$(document).on("click",".modal-overlay",function(e){e.target===this&&$(".modal-overlay").fadeOut()}),e}function createSelectElement(a,i,e=!1){var t=$("<div>",{class:"optionGroup"}),n=$("<div>",{class:"optionSelected"}),o=$("<div>",{class:"container-select"});let s=!i,l=s?"COMPRA RECORRENTE":"";s||([r]=i.trim().split(" "),d=1<parseInt(r)?"meses":"mês",l=`A cada <strong>${r} ${d}</strong>`);var r=$("<span>",{class:"text",html:l}),d=$("<span>",{class:"icon",text:""}),r=(n.append(r,d),s?n.addClass("button-initial"):n.addClass("selected"),a.map(e=>{var[e]=e.trim().split(" ");return e+" "+(1<parseInt(e)?"meses":"mês")}));let c=$("<div>",{class:"options",style:"display:none"});r.forEach((e,t)=>{var n=!s&&i&&i.trim()===a[t].trim(),t=$(`<div id="${a[t]}" class="option${n?" selected":""}">A cada&nbsp;<strong>${e}</strong></div>`);c.append(t)}),c.prepend('<div class="option" id="remove" style="cursor:no-drop;pointer-events:none">Selecione a frequência</div>'),o.append(n,c),t.append(o),t.append("<div class='buttons-container'></div>");d=t.find(".buttons-container");return e&&d.append(`<button class="removeSignature">
...
<path d="M10 15C10.2833 15 10.521 14.904 10.713 14.712C10.905 14.52 11.0007 14.2827 11 14V10C11 9.71667 10.904 9.47933 10.712 9.288C10.52 9.09667 10.2827 9.00067 10 9C9.71733 8.99933 9.48 9.09533 9.288 9.288C9.096 9.48067 9 9.718 9 10V14C9 14.2833 9.096 14.521 9.288 14.713C9.48 14.905 9.71733 15.0007 10 15ZM10 7C10.2833 7 10.521 6.904 10.713 6.712C10.905 6.52 11.0007 6.28267 11 6C10.9993 5.71733 10.9033 5.48 10.712 5.288C10.5207 5.096 10.2833 5 10 5C9.71667 5 9.47933 5.096 9.288 5.288C9.09667 5.48 9.00067 5.71733 9 6C8.99933 6.28267 9.09533 6.52033 9.288 6.713C9.48067 6.90567 9.718 7.00133 10 7ZM10 20C8.61667 20 7.31667 19.7373 6.1 19.212C4.88334 18.6867 3.825 17.9743 2.925 17.075C2.025 16.1757 1.31267 15.1173 0.788001 13.9C0.263335 12.6827 0.000667933 11.3827 1.26582e-06 10C-0.000665401 8.61733 0.262001 7.31733 0.788001 6.1C1.314 4.88267 2.02633 3.82433 2.925 2.925C3.82367 2.02567 4.882 1.31333 6.1 0.788C7.318 0.262667 8.618 0 10 0C11.382 0 12.682 0.262667 13.9 0.788C15.118 1.31333 16.1763 2.02567 17.075 2.925C17.9737 3.82433 18.6863 4.88267 19.213 6.1C19.7397 7.31733 20.002 8.61733 20 10C19.998 11.3827 19.7353 12.6827 19.212 13.9C18.6887 15.1173 17.9763 16.1757 17.075 17.075C16.1737 17.9743 15.1153 18.687 13.9 19.213C12.6847 19.739 11.3847 20.0013 10 20ZM10 18C12.2333 18 14.125 17.225 15.675 15.675C17.225 14.125 18 12.2333 18 10C18 7.76667 17.225 5.875 15.675 4.325C14.125 2.775 12.2333 2 10 2C7.76667 2 5.875 2.775 4.325 4.325C2.775 5.875 2 7.76667 2 10C2 12.2333 2.775 14.125 4.325 15.675C5.875 17.225 7.76667 18 10 18Z" fill="black"/>
</svg></button>`),t}function sendActionSignature({index:e,method:t,frequency:n,callback:a}){fetch(`/api/checkout/pub/orderForm/${vtexjs.checkout.orderFormId}/items/${e}/attachments/vtex.subscription.assinatura`,{method:t,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:{"vtex.subscription.key.frequency":n||""}})}).then(e=>e.json()).then(e=>{a&&a()}).catch(e=>console.error("Erro:",e))}function hideIcon(e){e=e.find(".icon");e.hide(),e.css({display:"none",visibility:"hidden",opacity:"0",position:"absolute","pointer-events":"none"}),e.addClass("hidden")}function verifyLoggedIn(){let t=window.location?.hash,n=setInterval(()=>{var e=(vtexjs?.checkout?.orderForm)?.loggedIn;void 0!==e&&(clearInterval(n),!e&&t.includes("/shipping")||t.includes("/payment"))&&checkout.login()},1e3)}$("body").on("click","#r .shipping-option-info",function(){$(".shipping-option-info-input").removeClass("clicado"),$(".shipping-option-info").removeClass("clicado"),$(this).addClass("clicado"),$(this).find(".shipping-option-info-input").addClass("clicado");var e=$("tr.Items td.monetary").text().split("R$ ")[1],t=$(this).find("span.shipping-option-price")[0],n=0,t=(t&&(n=parseFloat(t.innerText.replace("R$","").replace(",","."))),descontoElement=$("tr.Discounts td.monetary"),desconto=0,$(this).find("span.shipping-option-text").text()),t=(t?$("span.shipping-estimate-date:not(.shipping-estimate-detail)").text(t):(t=$(this).find("input[type='radio']").val(),0<(t=$(".srp-delivery-select option[value='"+t+"']")).length&&(t=t.text().split("-")[0],$("span.shipping-estimate-date:not(.shipping-estimate-detail)").text(t))),e=Number.isNaN(e)?0:parseFloat(e.replace(",",".")),0<descontoElement.length&&(t=descontoElement.text().split("R$ ")[1],desconto=Number.isNaN(t)?0:parseFloat(t.replace(",","."))),desconto=-desconto,n=Number.isNaN(n)?0:n,$(".srp-summary-result td.monetary").text("R$ "+n.toFixed(2).replace(".",",")),$(".srp-summary-result td.monetary").closest("table").find("tfoot td.monetary").text("R$ "+e.toFixed(2).replace(".",",")),e+n-desconto);$(".accordion-inner tfoot td.monetary").text("R$ "+t.toFixed(2).replace(".",","))}),$(window).on("orderFormUpdated.vtex",function(e,t){var n=setInterval(function(){$(".srp-delivery-select").length&&(checkShippingOptions(),clearInterval(n))},100);localStorage.getItem("activeDeliveryChannel")&&"pickup-in-point"==localStorage.getItem("activeDeliveryChannel")?$("#r").hide():$("#r").show()}),$(document).ready(function(){var e=setInterval(function(){$(".srp-delivery-select").length&&(checkShippingOptions(),clearInterval(e))},100);setInterval(function(){$(".srp-postal-code").length&&$("#r").remove()},100)}),$(window).on("hashchange",function(){window.location.hash.match(/shipping/g)&&$("#delivery-packages-options .shp-lean-option").each(function(e,t){$("#r input.clicado").attr("value")==$(this).attr("id")&&$(this).click()})}),$(".srp-address-title").click(function(){setInterval(function(){orderForm.shippingData.logisticsInfo[0].selectedDeliveryChannel;var e=("best-pickupPoint-"+orderForm.shippingData.logisticsInfo[0].selectedSla).replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1");0<$("."+e).length&&$("."+e).addClass("selected-pickuppoint")},100)}),document.addEventListener("DOMContentLoaded",function(){function n(){var e,t=document.querySelector(".free-shipping__barActive");t&&(e=(t.getAttribute("style")||"").match(/width:\s*([\d.]+)%/))&&(e=parseFloat(e[1]),t.style.backgroundColor=100<=e?"#0D986A":"#211E1E")}!function e(){var t=document.querySelector(".free-shipping__barActive");t?(n(),new MutationObserver(function(e){n()}).observe(t,{attributes:!0,attributeFilter:["style"]})):setTimeout(e,500)}()}),$(document).ready(function(){renderModal(),$(window).on("orderFormUpdated.vtex",function(e,i){i.items.map((e,t)=>{var n,a;0<e.attachmentOfferings.length&&((n=$(`tr.product-item[data-sku="${e.id}"] td.product-name`)).find(".optionGroup").remove(),(e=createSelectElement((a=e.attachmentOfferings[0].schema)[Object.keys(a)[0]].domain,(a=e.attachments?.find(e=>"vtex.subscription.assinatura"===e.name))?.content?.["vtex.subscription.key.frequency"],!!a)).attr("data-index",t),e.attr("data-orderform-id",i.orderFormId),n.append(e))})}),$(document).on("click",".optionSelected",function(){var e=$(this),t=e.siblings(".options");e.find(".icon").css({opacity:"1"}),t.is(":visible")?(t.hide(),"COMPRA RECORRENTE"===e.find(".text").text().trim().toUpperCase()&&(e.removeClass("selected").addClass("button-initial"),e.find(".text").text("COMPRA RECORRENTE"),e.css({border:"1.5px solid #006ea8",color:"#006ea8","text-transform":"uppercase","font-weight":"700","justify-content":"center"}),e.find(".icon").css({opacity:"0"}))):($(".options").hide(),t.show()),e.hasClass("button-initial")&&(e.removeClass("button-initial").addClass("selected"),e.find(".icon").show(),e.find(".icon").css({transform:"rotate(-180deg)"}))}),$(document).on("click",".option",function(){var e=$(this),t=e.closest(".optionGroup"),n=t.find(".optionSelected"),a=e.html(),a=(n.find(".text").html(a),n.removeClass("button-initial").addClass("selected"),n.find(".icon").show(),t.find(".options").hide(),t.find(".option").removeClass("selected"),e.addClass("selected"),e.attr("id"));sendActionSignature({index:t.data("index"),method:"POST",frequency:a,callback:function(){vtexjs.checkout.getOrderForm().done(function(e){$(window).trigger("orderFormUpdated.vtex",e)})}})}),$(document).on("click",".removeSignature",function(){sendActionSignature({index:$(this).closest(".optionGroup").data("index"),method:"DELETE",callback:function(){vtexjs.checkout.getOrderForm().done(function(e){$(window).trigger("orderFormUpdated.vtex",e)})}})})}),$(window).on("orderFormUpdated.vtex",function(e,t){let n=$(".empty-cart-content"),a=$(".title-bottom-vitrine"),i=("display: block;"==n.attr("style")&&(a.attr("style","display: none !important;"),clearInterval(i)),setInterval(()=>{"display: block;"==n.attr("style")&&(a.attr("style","display: none !important;"),clearInterval(i))},50));clearInterval(i)}),document.body.insertAdjacentHTML("beforeend",`
  ...
  `),$(document).on("click",".payment-group-item#payment-group-bankInvoicePaymentGroup",function(e){$("#custom-payment-modal").css("display","flex").hide().fadeIn(200)}),$(document).on("click","#custom-payment-modal .modal-close",function(){$("#custom-payment-modal").fadeOut(200)}),(()=>{if(!window.__receitaSelectorInitialized){window.__receitaSelectorInitialized=!0;let o="receita-modal-overlay",s="isReceitaFisica",l="pensefarma_receita_fisica",r=null;function t(){var e=document.querySelector(".srp-toggle__pickup");return e&&e.classList.contains("blue")}function n(){var e;return t()||((e=document.querySelector(".srp-toggle__pickup"))&&e.click(),t())}function d(){var e;document.body.classList.contains(s)&&(n()?r&&(clearInterval(r),r=null):r||(e=0,r=setInterval(function(){e++,(n()||30<=e)&&(clearInterval(r),r=null)},500)))}function c(e){let t=e.nextElementSibling;for(;t&&!t.classList.contains("product-item");){if(t.classList.contains("receita-container"))return t;t=t.nextElementSibling}return null}function e(){var e=document.querySelectorAll(".product-item");e.length&&e.forEach(e=>{var t;!e.querySelector(".info-receita")||e.nextElementSibling&&e.nextElementSibling.classList.contains("custom-selector-row")||(t=c(e))&&(t.style.display="none",(t=document.createElement("tr")).className="custom-selector-row",t.innerHTML=`
      <td colspan="7">
    ...
    `,e.insertAdjacentElement("afterend",t))})}document.addEventListener("click",e=>{var t,n,a,i;e.target.closest(".m-close")?(t=document.getElementById(o))&&(t.style.display="none"):(t=e.target.closest(".btn-digital-trigger"))?(document.body.classList.remove(s),sessionStorage.removeItem(l),r&&(clearInterval(r),r=null),(a=(a=t).closest(".custom-selector-row"))&&(a=a.previousElementSibling)&&a.classList.contains("product-item")&&(a=c(a))&&(n="none"===getComputedStyle(a).display,a.style.display=n?"":"none",n)&&a.scrollIntoView({behavior:"smooth",block:"start"})):(n=e.target.closest(".btn-fisica-trigger"))?((i=(i=(a=n.closest(".custom-selector-row"))?a.previousElementSibling:null)&&i.classList.contains("product-item")?c(i):null)&&(i.style.display="none"),(i=document.getElementById(o))||((i=document.createElement("div")).id=o,i.className="m-overlay",i.style.display="none",i.innerHTML=`
      <div class="m-box">
    ...
    `,document.body.appendChild(i)),i.style.display="flex"):(i=e.target.closest("#btn-modal-confirm"))&&!i.disabled&&(document.body.classList.add(s),sessionStorage.setItem(l,"1"),d(),e=document.getElementById(o))&&(e.style.display="none")}),document.addEventListener("change",e=>{var t,e=e.target.closest("#check-modal");e&&(t=document.getElementById("btn-modal-confirm"))&&(t.disabled=!e.checked,t.classList.toggle("active",e.checked))}),"1"===sessionStorage.getItem(l)&&(document.body.classList.add(s),d()),e(),setTimeout(e,500),setTimeout(e,1500),$(window).on("orderFormUpdated.vtex",function(){d()}),new MutationObserver(function(){e(),d()}).observe(document.body,{childList:!0,subtree:!0})}})(),$(document).ready(function(){verifyLoggedIn()}),$(window).on("hashchange",()=>{verifyLoggedIn()});